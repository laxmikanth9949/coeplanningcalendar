sap.ui.define([
    "sap/coe/planning/calendar/fragment/ProductSearch.fragment.controller",
    ...
    QUnit.test("Should be possible to create an instance", function(assert) {
        ...
        assert.strictEqual(this.oProductSearchController.getMetadata().getName(), "sap.coe.planning.calendar.fragment.ProductSearch", "Was created with the expected name");
